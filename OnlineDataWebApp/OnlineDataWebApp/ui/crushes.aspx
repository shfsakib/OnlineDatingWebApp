<%@ Page Title="" Language="C#" MasterPageFile="~/ui/root.Master" AutoEventWireup="true" CodeBehind="crushes.aspx.cs" Inherits="OnlineDataWebApp.ui.crushes" %>
            ...
            <div class="container pt-5">
                <div class="row">
                    <div class="col-12 text-center">
                        <h3 class="font-bold">Crush List</h3>
                    </div>
                    <div class="col-12">
                        <div class="row">
                    <div class="card card-body col-12 m-3" runat="server" visible="False" id="noDataDiv">
                        <h4>No Crush Found</h4>
                    </div>
                    <asp:Repeater ID="repeaterUser" runat="server" OnPreRender="repeaterUser_OnPreRender" OnItemDataBound="repeaterUser_OnItemDataBound">
                        <ItemTemplate>
                            <div class="col-6 col-sm-3 col-md-4 col-lg-3" style="margin: 0 0 !important; padding: 5px 10px !important;">
                                <div class="card card-body m-2">
                                    <a style="cursor: pointer; text-decoration: none;" href='<%#"/ui/profile-details.aspx?id="+Eval("UserId")+"&type=crush" %>'>
                            ...
                            <asp:LinkButton ID="lnkDate" class="btn btn-primary mt-2 btn-block" OnClick="lnkDate_OnClick" runat="server"><i class="fas fa-street-view"></i>&nbsp;&nbsp;Ask for Date</asp:LinkButton>                                                   
